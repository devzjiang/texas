...
public class TayeeSyncLock {
     ...
     */
    public TayeeSyncLock(Jedis jedis, String lockKey) {
        this.jedis = jedis;
     ...
     */
    public TayeeSyncLock(Jedis jedis, String lockKey, int timeoutMsecs) {
        this(jedis, lockKey);
     ...
     */
    public TayeeSyncLock(Jedis jedis, String lockKey, int timeoutMsecs, int expireMsecs) {
     ...
     *            lock key (ex. account:1, ...)
     */
    public TayeeSyncLock(String lockKey) {
        this(null, lockKey);
    }
     ...
     *            acquire timeout in miliseconds (default: 10000 msecs)
     */
    public TayeeSyncLock(String lockKey, int timeoutMsecs) {
     ...
     *            lock expiration in miliseconds (default: 60000 msecs)
     */
    public TayeeSyncLock(String lockKey, int timeoutMsecs, int expireMsecs) {
